...
export default function OverallStats(props) {
    ...
    return (
        <div className="mb-10 min-w-fit h-44 w-3/5 border-solid border p-6 pl-8  border-slate-300/10 hover:border-slate-50/10 bg-gray-900/40 ackdrop-blur-sm rounded-2xl flex flex-wrap pr-0">
